...
- (void)initScrollView {
    ...
    self.posterImageView.image = [UIImage imageNamed:@"IMG_0651.JPG"];
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView {
    ...
    if (yOffset < 0) {
        ...
        CGFloat height = self.posterImageView.frame.size.height - yOffset;
...
//
//        [self.introductionView remakeConstraints:^(MASConstraintMaker *make) {
//            make.top.equalTo(self.posterImageView.bottom);
//            make.height.equalTo(@183);
//            make.width.equalTo(@(ScreenWidth));
//        }];
//        
//        [self.detailTextView remakeConstraints:^(MASConstraintMaker *make) {
//            make.top.equalTo(self.introductionView.bottom).offset(16);
//            make.width.equalTo(@(ScreenWidth - 16));
//            make.height.equalTo(@1200);
//        }];
